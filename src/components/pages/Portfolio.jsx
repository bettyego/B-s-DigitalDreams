  ...
  const projects = [
    {
      ...
      description: "A modern online fashion store with advanced filtering, wishlist functionality, and secure payment integration. Features include user authentication, order tracking, and admin dashboard.",
      image: "/web1.jpg",
      category: "ecommerce",
    ...
    },
    {
      ...
      description: "A sleek, minimalistic portfolio showcasing an interior designer's work with stunning image galleries, project case studies, and client testimonials.",
      image: "/web2.jpg",
      category: "portfolio",
      tech: ["React", "TailwindCSS", "Framer Motion", "Sanity CMS"],
      liveUrl: "https://interior-portfolio-demo.com",
    ...
    },
    {
      ...
      description: "Comprehensive web application for shipment tracking, quote requests, route optimization, and real-time delivery updates with user authentication.",
      image: "/web3.jpg",
      category: "webapp",
      tech: ["React", "Firebase", "Google Maps API", "TailwindCSS"],
      liveUrl: "https://logistics-tracker-demo.com",
    ...
    },
    {
      ...
      description: "Complete restaurant website with online menu, table reservations, order management, and integrated POS system for seamless operations.",
      image: "/web4.webp",
      category: "business",
    ...
    },
    {
      ...
      description: "Advanced property listing platform with search filters, virtual tours, mortgage calculator, agent profiles, and lead management system.",
      image: "/web5.webp",
      category: "webapp",
    ...
    },
    {
      ...
      description: "Stunning portfolio website for a creative agency featuring smooth animations, case studies, team profiles, and interactive project showcases.",
      image: "/graphic1.jpeg",
      category: "portfolio",
